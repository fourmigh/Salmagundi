package org.caojun.library.fragment
...
import org.caojun.library.utils.FileUtils
...
//        mGridView = view.findViewById(R.id.grid) as GridView
        ...
        grid.onItemClickListener = AdapterView.OnItemClickListener { adapterView, _, i, l ->
...
//        })
    ...
    private fun createPopupFolderList() {
        ...
        mFolderPopupWindow?.setOnItemClickListener { adapterView, _, i, l ->
