...
public abstract class CarouselViewGroup<T extends Adapter> extends ViewGroup {
     ...
     */
    @ViewDebug.ExportedProperty
    public int mNextSelectedPosition = INVALID_POSITION;
     ...
     */
    @ViewDebug.ExportedProperty
    public int mSelectedPosition = INVALID_POSITION;

    /**
     * The item id of the currently selected item.
     */
    public long mSelectedRowId = INVALID_ROW_ID;
    ...
    public CarouselViewGroup(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(CarouselViewGroup<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(CarouselViewGroup<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(CarouselViewGroup<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(CarouselViewGroup<?> parent);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (CarouselViewGroup.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                CarouselViewGroup.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (CarouselViewGroup.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = CarouselViewGroup.this.onSaveInstanceState();
            }
