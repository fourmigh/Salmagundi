...
package org.caojun.library.cropimage;
...
class HighlightView {
    ...
    private View mView;  // The View displaying the image.
    ...
    private void init() {
        ...
        mResizeDrawableWidth = ContextCompat.getDrawable(mView.getContext(), org.caojun.library.R.drawable.camera_crop_width);
        mResizeDrawableHeight = ContextCompat.getDrawable(mView.getContext(), org.caojun.library.R.drawable.camera_crop_height);
        mResizeDrawableDiagonal = ContextCompat.getDrawable(mView.getContext(), org.caojun.library.R.drawable.indicator_autocrop);
    }
