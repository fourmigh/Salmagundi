...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = ContextCompat.getDrawable(mView.getContext(), R.drawable.camera_crop_width);
        mResizeDrawableHeight = ContextCompat.getDrawable(mView.getContext(), R.drawable.camera_crop_height);
        mResizeDrawableDiagonal = ContextCompat.getDrawable(mView.getContext(), R.drawable.indicator_autocrop);
    }
