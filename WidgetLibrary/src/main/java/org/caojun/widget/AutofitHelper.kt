...
class AutofitHelper {
    ...
    companion object {
         ...
         */
        fun create(view: TextView): AutofitHelper = create(view, null, 0)

        /**
         * Creates a new instance of `AutofitHelper` that wraps a [TextView] and enables
         * automatically sizing the text to fit.
         */
        fun create(view: TextView, attrs: AttributeSet): AutofitHelper = create(view, attrs, 0)
        ...
        fun create(view: TextView, attrs: AttributeSet?, defStyle: Int): AutofitHelper {
            ...
            if (attrs != null) {
                ...
                helper.setMinTextSize(TypedValue.COMPLEX_UNIT_PX, minTextSize.toFloat()).setPrecision(precision)
            }
    ...
    private fun getAutofitTextSize(text: CharSequence, paint: TextPaint,
        ...
        if (lineCount > maxLines) {
            ...
            return if (high - low < precision) {
                low
            } else getAutofitTextSize(text, paint, targetWidth, maxLines, low, mid, precision, displayMetrics)
     ...
     */
    fun setMaxTextSize(size: Float): AutofitHelper = setMaxTextSize(TypedValue.COMPLEX_UNIT_SP, size)
    ...
    private fun autofit() {
        val oldTextSize = mTextView?.textSize?:0f
//        val textSize: Float
        ...
        val textSize: Float = mTextView?.textSize?:0f
