package org.caojun.library.velocimeter.painter.inside
 ...
 */
class InsideVelocimeterPainterImp: VelocimeterPainter, InsideVelocimeterPainter {
    ...
    private fun initSize() {
        ...
        this.strokeWidth = DimensionUtils.getSizeInPixels(context!!, 1f)
    ...
    private fun initCircle() {
        val padding = externalStrokeWidth + margin + blurMargin
        circle = RectF()
